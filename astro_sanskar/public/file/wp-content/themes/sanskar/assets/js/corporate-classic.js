...
jQuery(document).ready(function($) {
    ...
    if (!$('body').hasClass('verso-agent-touch') && $('.verso-nav').hasClass('verso-nav-hover')) {
		...
		$('.verso-nav-menu ul li ul li').on('mouseover', function() {
			
            $(this).find('.verso-nav-dropdown2').removeClass('closed');
        }).on('mouseout', function() {
            $(this).find('.verso-nav-dropdown2').addClass('closed');
			
        });
		$('.verso-nav-menu ul li ul li').on('mouseover', function() {
			
            $(this).find('.verso-nav-dropdown3').removeClass('closed');
        }).on('mouseout', function() {
            $(this).find('.verso-nav-dropdown3').addClass('closed');
